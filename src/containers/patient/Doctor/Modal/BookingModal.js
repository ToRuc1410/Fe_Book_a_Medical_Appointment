...
class BookingModal extends Component {
    ...
    handleConfirmBooking = async () => {
        ...
        if (res && res.errCode === 0) {
            toast.success('Booking a new appointment is Successed. Please Check your mail...');
            ...
            >
                ...
                <div className="card-body bg-light">
                    <div className='d-flex justify-content-between'>
                        <h5 className="card-title"><FormattedMessage id="patient.booking-modal.title" /></h5>
                ...
                <div className="card-footer py-3">
                    <span className='float-end '>
                        <button className='btn btn-warning me-2' onClick={() => this.handleConfirmBooking()}><FormattedMessage id="patient.booking-modal.confirm" /></button>
                        <button className='btn btn-secondary' onClick={closeModal}><FormattedMessage id="patient.booking-modal.close" /></button>
                    </span>
                </div>
