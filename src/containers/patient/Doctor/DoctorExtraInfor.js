        ...
        return (
            <>
                <div className='container-fluid'>
                    <div className='title'>
                        <p><FormattedMessage id="patient.extraInfor-doctor.address" /></p>
                    </div>
                    <div>
                        <b>{extraInfor && extraInfor.nameClinic ? extraInfor.nameClinic : ''}</b>
                    ...
                    <div>
                        {isShowDetailInfor === false &&
                            <div className='d-flex justify-content-between'>
                                ...
                                <span className='text-primary' style={{ cursor: "pointer" }} onClick={() => this.showHideDetailInfor(true)}
                                > <FormattedMessage id="patient.extraInfor-doctor.seemore" /></span>
                            </div>
                        }
                        <div>
                                ...
                                <>
                                    <div className='rounded-3 bg-light border p-2'>
                                        <div className='d-flex justify-content-between fs-5'>
                                            <span><FormattedMessage id="patient.extraInfor-doctor.price" /></span>
                                            <span>
                                                {extraInfor && extraInfor.priceTypeData && language === LANGUAGES.VI
                                                    &&
                                                    <NumberFormat
                                    ...
                                    <div className='border p-2 rounded-3 mb-2' style={{ backgroundColor: "#e7e9eb" }}>
                                        <span>
                                    ...
                                    ><FormattedMessage id="patient.extraInfor-doctor.hide" /></span>
                                </>
                            }
                        </div>
                    </div>
