...
class ManageDoctor extends Component {
    ...
    handleSaveContentMarkdown = () => {
        ...
        this.props.saveDetailADoctor({
            ...
            clinicId: this.state.selectedClinic && this.state.selectedClinic.key ? this.state.selectedClinic.key : '',
        })
        this.setState({
            contentHTML: '',
            contentMarkdown: '',
    ...
    render() {
        ...
        return (
            <div className='container-fluid'>
                    ...
                    <div className='row mb-3'>
                        ...
                        <div className="col-7 form-floating">
                            <textarea className="form-control" placeholder="Leave a comment here"
                                id="floatingTextarea" style={{ height: '90px' }}
                                onChange={(event) => this.handleOnChangeText(event, 'description')}
                                value={this.state.description}
                            />

                            <label htmlFor="floatingTextarea"><FormattedMessage id={"admin.manage-doctor.introduce"} /></label>
                        </div>
                    </div>
                    <div className='row'>
                ...
                <div>
                    <h3 className="card-header text-center"><b><FormattedMessage id={"admin.manage-doctor.information"} /></b></h3>
                ...
                <div>
                    <button
                        ...
                        className={hasOldData === false ? 'btn btn-outline-primary m-3 px-auto' : 'btn btn-outline-warning m-3 px-auto'}>
                        {hasOldData === false ? <span><FormattedMessage id={"admin.manage-doctor.add"} /></span> : <span><FormattedMessage id={"admin.manage-doctor.save"} /></span>}
                    </button>
                </div>
            </div>
        );
